...
<div class="mb-16 flex items-center justify-between">
  ...
  <div>
    <button class="relative translate-y-0 whitespace-nowrap rounded-lg bg-lavenderIndigo px-10 py-3 font-sansSerif text-xl font-black text-white shadow-colored transition-all hover:-translate-y-2 hover:shadow-coloredHover">+ Invoice</button>
  </div>
</div>
